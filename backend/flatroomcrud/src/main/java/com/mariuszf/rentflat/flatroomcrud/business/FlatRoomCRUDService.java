package com.mariuszf.rentflat.flatroomcrud.business;

import com.mariuszf.rentflat.flatroomcrud.database.FlatEntity;
...
@Service
public class FlatRoomCRUDService {

    private FlatRepository flatRepository;
    private RoomRepository roomRepository;

    @Autowired
    public FlatRoomCRUDService(FlatRepository flatRepository, RoomRepository roomRepository) {
